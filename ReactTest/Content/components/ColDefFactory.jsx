...
export default class ColDefFactory {
    ...
    createColDefs() {
        ...
        var columnDefs = [
            ...
            suppressMenu: false, pinned: false},
            {headerName: 'Date of Assignemnt', field:'Date_of_Assignment', width: 100, suppressSorting: true,
            suppressMenu: false, pinned: false, filter:'date'},
            {headerName: 'Time', field:'Time_of_Assignment', width: 100, suppressSorting: true,
            suppressMenu: false, pinned: false},
            {headerName: 'Patient Last_Name', field:'Last_Name', width: 100, suppressSorting: true,
            suppressMenu: false, pinned: false},
            {headerName: 'Patient First Name', field:'First_Name', width: 100, suppressSorting: true,
            suppressMenu: false, pinned: false},

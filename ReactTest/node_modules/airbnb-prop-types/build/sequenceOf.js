...
function validateChunks(specifiers, props, propName, componentName) {
  ...
  for (var i = 0; i < specifiers.length; i += 1) {
    ...
    var chunkError = arrayOfValidator.apply(undefined, [Object.assign({}, props, _defineProperty({}, propName, chunk)), propName, componentName].concat(rest));
...
var specifierValidator = (0, _withShape2['default'])((0, _object2['default'])(), specifierShape).isRequired;

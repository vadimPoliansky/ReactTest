...
function childrenSequenceOfValidator() {
  ...
  var validator = function () {
    function childrenSequenceOf(props, propName, componentName) {
      ...
      return seq.apply(undefined, [Object.assign({}, props, { children: children }), propName, componentName].concat(rest));
    }
  ...
  validator.isRequired = function () {
    function childrenSequenceOfRequired(props, propName, componentName) {
      ...
      return seq.isRequired.apply(seq, [Object.assign({}, props, { children: children }), propName, componentName].concat(rest));
    }
